...
public class AES {
    ...
    private final int[] MCOL = {2, 3, 1, 1, 1, 2, 3, 1, 1, 1, 2, 3, 3, 1, 1, 2};
    private final int[] MCOL_INV = {14, 11, 13, 9, 9, 14, 11, 13, 13, 9, 14, 11, 11, 13, 9, 14};
    private byte[] data;
